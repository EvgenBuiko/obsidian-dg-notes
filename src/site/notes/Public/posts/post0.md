...
#TODO - переделать так чтобы сдесь была только основная инфа а части относящиеся к посту должны быть перенесены в пост 
